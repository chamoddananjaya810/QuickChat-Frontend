...
export default function AvatarScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white ">
      ...
      <View className="items-center flex-1 bg-red-100">
        <View>
          <Image
        ...
        <View className="items-center">
          ...
          <View className="items-center mt-2 h-72">
            ...
            <Text className="my-2 text-lg font-bold text-slate-600">
              Or select an awatar
            </Text>
            <FlatList
              data={avatars}
              ...
              renderItem={({ item }) => (
                ...
                >
                  <Image
                    source={item}
                    className="w-20 h-20 mx-2 border-gray-200 rounded-full"
                  />
                </TouchableOpacity>
              )}
        ...
        <View className="w-full px-5 mt-2 bg-red-100">
          <Pressable
